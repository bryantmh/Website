...
app.post('/api/items', (req, res) => {
  id = id + 1;
  let item = {id:id, text: req.body.text, priority: req.body.priority, completed: req.body.completed, completedDate: req.body.completedDate};
  items.push(item);
  res.send(item);
});
...
app.put('/api/items/:id', (req, res) => {
  ...
  item.completedDate = req.body.completedDate;
